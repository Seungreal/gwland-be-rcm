...
public class Crawler {
	...
	public static void main(String[] args) {
		...
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/21449945","1");      //뉴욕제과
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/19125965","2");      //함흥냉면옥
...
//양식x	placeAutoUrl(revList, driver,"https://place.map.kakao.com/20089686","18");     //뉴스타트설악리조트
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/1618971940","19");   //다이나믹 메이즈
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/9703855","20");      //단천식당
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/9697792","21");      //대궐파크
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/21814112","22");     //대포마을
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/10324177","23");     //대포항
																		      //예외처리(24)
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/315908155","25");    //더 레드 하우스
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/27010613","26");     //동명방파제
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/12656758","27");     //동명마을
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/1123919078","28");   //전복해물뚝배기
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/7843350","29");      //동명항
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/11892233","30");     //동해순대국
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/10364864","31");     //두메산골
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/7851701","32");      //등대해변
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/27392264","33");     //롯데리조트 속초
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/8998463","34");      //모아모텔
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/11248590","35");     //미라지모텔
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/20706973","36");     //발해역사관
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/26035534","37");     //백두해물짬뽕순두부
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/14749593","38");     //베니키아 호텔 산과바다 대포항
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/11305083","39");     //보광사
//양식x	placeAutoUrl(revList, driver,"https://place.map.kakao.com/1364813679","40");   //본가 궁중해장국
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/10455856","41");     //블루오션설악밸리
//양식x	placeAutoUrl(revList, driver,"https://place.map.kakao.com/7902860","42");      //비룡폭포
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/7904044","43");      //비선대
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/8340024","44");      //사돈집
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/853690564","45");    //상도문돌담마을
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/7951458","46");      //석봉도자기미술관
																		      //예외처리(47)
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/23256180","48");     //설악 대청봉
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/7949134","49");      //설악 케이블카
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/12664858","50");     //설악 파인리조트 가든스파
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/11134307","51");     //설악 흔들바위
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/8693759","52");      //설악금호리조트
//양식x	placeAutoUrl(revList, driver,"https://place.map.kakao.com/21054684","53");     //설악동야영장
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/17721245","54");     //설악레저스쿨
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/8216362","55");      //설악산 권금성
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/8036325","56");	  //설악산 울산바위
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/24414762","57");	  //설악산 자생식물원
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/8375070","58");      //설악산 탐방안내소
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/7944159","59");	  //설악산가족호텔
//양식x	placeAutoUrl(revList, driver,"https://place.map.kakao.com/21054684","60");     //설악산국립공원 자동차야영장
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/15147983","61");     //설악산국립공원(외설악)
																			  //예외처리(62)
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/26290244","63");     //설악산소공원
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/9168616","64");      //설악산파크리조트
																			  //예외처리(65)
//양식x	placeAutoUrl(revList, driver,"https://place.map.kakao.com/10494265","66");     //설악파인리조트
...
//양식x	placeAutoUrl(revList, driver,"https://place.map.kakao.com/8376588","71");      //설악해맞이공원
		...
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/1970947390","74");   //외옹치 바다향기로
																		      //예외처리(75)
																			  //예외처리(76)
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/8065637","77");      //속초 조양동 유적
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/19304774","78");     //속초 하도문쌈채 마을,
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/1970947390","79");   //외옹치 바다향기로
...
//양식x	placeAutoUrl(revList, driver,"https://place.map.kakao.com/371169740","88");    //속초엑스포유람선
																			  //예외처리(89)
																		      //예외처리(90)
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/7958898","91");      //속초항
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/22099937","92");     //속초해변
																		      //예외처리(93)
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/1311816688","94");   //속초휘테
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/19947943","95");     //솔밭가든막국수
...
//양식x	placeAutoUrl(revList, driver,"https://place.map.kakao.com/11435044","100");    //시나브로 모텔
		...
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/11951680","105");    //아바이마을
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/19624242","106");    //아이리스9
...
//양식x	placeAutoUrl(revList, driver,"https://place.map.kakao.com/10650417","113");    //영랑호리조트
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/24451703","114");    //옛고을순두부
//양식x	placeAutoUrl(revList, driver,"https://place.map.kakao.com/10633799","115");    //오대양횟집
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/9267011","116");     //옥돌할머니순두부
//양식x	placeAutoUrl(revList, driver,"https://place.map.kakao.com/9293198","117");     //왕건횟집
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/632257610","118");   //외옹치마을
...
//양식x	placeAutoUrl(revList, driver,"https://place.map.kakao.com/10688023","123");    //육담폭포
		...
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/13606733","125");    //장사마을
																			  //에외처리(126)
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/10737561","127");    //장사항
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/11441632","128");    //장원파크텔
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/21345651","129");    //재래식할머니순두부
																		      //예외처리(130)
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/11170136","131");    //전주속풀이해장국
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/13320662","132");	  //점봉산산채
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/9395122","133");     //조광모텔
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/18682831","134");    //족욕공원
																			  //에외처리(135)
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/8086528","136");  	  //진미횟집
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/10763109","137");    //진솔할머니순두부
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/8086427","138");     //진양횟집
...
//양식x	placeAutoUrl(revList, driver,"https://place.map.kakao.com/8088618","145");     //청대산
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/16106479","146");    //청초비치 모텔
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/26602585","147");    //청초수물회
																			  //예외처리(148)
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/8105816","149");	  //청초호
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/11247110","150");    //청호해변
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/27158330","151");    //청호활어회센터
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/10842950","152");    //초당할머니집
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/125251387","153");   //초원리조텔
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/9511628","154");     //최옥란할머니순두부
...
//양식x	placeAutoUrl(revList, driver,"https://place.map.kakao.com/25035970","159");    //토왕성폭포
		...
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/12706186","162");    //학사평 콩꽃마을 순두부촌
//양식x	placeAutoUrl(revList, driver,"https://place.map.kakao.com/21510540","163");    //한송정가든
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/10482115","164");    //한화리조트 설악 워터피아
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/27025531","165");    //한화리조트 설악
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/8149034","166");     //해림모텔
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/10923704","167");    //해맞이모텔
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/26564223","168");    //해파랑길 45코스
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/27491575","169");    //해피하우스
		placeAutoUrl(revList, driver,"https://place.map.kakao.com/9641200","170");     //헬리오스모텔
